...
public class CallableSpSaldoItensMensalAgo implements Callable<List<SaldosMensais>>{

	 private String codigo;
	 private String ano;
	 private String cnpj;
	 
	 public CallableSpSaldoItensMensalAgo(String codigo,String ano,String cnpj) { 
		 this.codigo = codigo;
		 this.ano = ano;
		 this.cnpj = cnpj;
	 }
